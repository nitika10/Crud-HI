		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Header Item Crud",
									"targetURL": "#comcrudhicrudhi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcrudhicrudhi-display": {
								"semanticObject": "comcrudhicrudhi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crud.hi.crudhi",
									"url": sap.ui.require.toUrl("com/crud/hi/crudhi")
								}
							}
						}
					}
